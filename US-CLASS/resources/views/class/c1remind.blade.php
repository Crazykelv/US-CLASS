...
<body style="background-image: url('body.jpg');">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-primary-subtle">
      ...
      <div class="container mt-5 pt-2 text-center w-50">
            <div class="col-6 rounded shadow p-5 me-5 mb-2 btn btn-warning" style="width: 65%;">
                <h4 class="text-light fs-1">Perhatian!!</h4><br>
                <span class="text-light fs-5">Kelas akan digunakan dalam waktu</span><br>
                <span class="text-light fs-5">Kurang dari 15 Menit!!</span>
            </div>
      </div>
